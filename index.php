...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?p=surat">Data Arsipan Surat</a></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="index.php?p=about">About</a></a>
            </li>
          </ul>
        </div>
		</div>
    ...
    <!-- End Line -->
	<div id="footer">
  <h3>&copy 2021 Sistem Informasi Pengarsipan Surat</h3>
		<h4>Made By: Evita Putri Nauli Simanungkalit</h4>
	</div>
